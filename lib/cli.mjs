...
${c(color.bright, "技能:")}
  ...
  ${c(color.cyan, "ui-material-design")}        根据参考图生成 UI 素材设计提示词（MJ/SD/DALL-E）
  ${c(color.cyan, "ui-material-design-image")}  根据参考图生成 AI 绘图模型提示词（gpt-image-2/seedream/qwen-image-3.0）
