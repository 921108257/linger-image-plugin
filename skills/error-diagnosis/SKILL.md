...
**开发模式（本地未发布）**：
```bash
node "C:/Users/92110/Desktop/BaseLinger/Plugin/image-plugin/bin/linger-image" error-diagnosis "<报错截图>" ["关注点"]
```
...
```bash
node "C:/Users/92110/Desktop/BaseLinger/Plugin/image-plugin/bin/linger-image" error-diagnosis "./ts-error.png"
node "C:/Users/92110/Desktop/BaseLinger/Plugin/image-plugin/bin/linger-image" error-diagnosis "./500-error.png" "重点看请求头和响应体"
node "C:/Users/92110/Desktop/BaseLinger/Plugin/image-plugin/bin/linger-image" error-diagnosis "./build-fail.png" "这是哪个依赖的问题"
```
...
# 1. 截图报错信息（控制台/终端/IDE）
# 2. 诊断
node "C:/Users/92110/Desktop/BaseLinger/Plugin/image-plugin/bin/linger-image" error-diagnosis ./error.png > diagnosis.md
